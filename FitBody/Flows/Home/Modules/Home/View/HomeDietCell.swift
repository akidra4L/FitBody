...
final class HomeDietCell: UITableViewCell {
    private lazy var containerView = makeContainerView()
    private lazy var illustrationImageView = UIImageView(image: Illustrations.homeDietIllustration)
    ...
    private func makeContainerView() -> UIView {
        ...
        view.backgroundColor = Colors.fillPrimary.withAlphaComponent(0.5)
    ...
    private func makeActionButton() -> UIButton {
        let button = PrimaryButton(size: .medium)
