...
// MARK: - HospitalSectionHeaderView

protocol HospitalSectionHeaderViewDelegate: AnyObject {
    func didTapActionButton(in view: HospitalSectionHeaderView)
}

// MARK: - HospitalSectionHeaderView

final class HospitalSectionHeaderView: UITableViewHeaderFooterView {
    private lazy var titleLabel = makeTitleLabel()
    private lazy var actionButton = makeActionButton()
    
    weak var delegate: HospitalSectionHeaderViewDelegate?
    ...
    func configure(with viewModel: HospitalSectionHeaderViewModel) {
